"""
NCI109 graph classification task 
...
class Args(ArgsTemplate):
    ...
    EXCLUDED_FEAT_IDX: Optional[list] = None # field(default_factory=lambda: [0, 13])
    N_NODE_FEATURES: int = 18 # 16 after dropping features [0, 13]
    CUSTOM_P_CMLTV_KLD_QUANTILES: Iterable[float] = (0.25, 0.5, 0.75) # (0.16, 0.33, 0.49, 0.66, 0.83)
    ...
    # CUSTOM_P_CMLTV_KLD_QUANTILES: Iterable[float] = (0.16, 0.33, 0.49, 0.66, 0.83)   
    # P_WAVELET_SCALES_PRECALC: Optional[list] = field(default_factory=lambda: \
    #     [ 0,  1,  2,  3,  4,  6,  8, 12, 32] # medians for T=32
    # )
    ...
    #     [ 0,  1,  2,  3,  4,  5,  6,  8, 10, 13, 32],
    #     [ 0,  1,  2,  3,  4,  5,  6,  7,  9, 12, 32],
    #     [ 0,  1,  2,  3,  3,  4,  5,  6,  7,  9, 32]]
    # )
    

    # data params
    # RAW_DATA_FILENAME: str = 'melanoma_manifolds_dictl.pkl'
    PYG_DATA_LIST_FILENAME: str = 'ptc_pyg_data_list.pkl'
    ...
    PYG_DATASET_KEY: str = 'PTC_MR'
    MODEL_SAVE_SUBDIR: str = 'PTC_MR'
    RESULTS_SAVE_SUBDIR: str = 'PTC_MR'
