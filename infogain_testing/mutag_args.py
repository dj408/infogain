"""
MUTAG graph classification task 
...
class Args(ArgsTemplate):
    ...
    EXCLUDED_FEAT_IDX: Optional[list] = None # field(default_factory=lambda: [4])
    CUSTOM_P_ZERO_FLOOR: Optional[float] = 1e-2
    CUSTOM_P_SUBSAMPLE_PROP: Optional[int] = None
    CUSTOM_P_SUBSAMPLE_SEED: int = 578439
    CUSTOM_P_CMLTV_KLD_QUANTILES: Iterable[float] = (0.25, 0.5, 0.75)
    ...
    MFCN_WITHIN_FILTER_CHAN_OUT: Tuple[int] = (8, ) # (8, 4)
    ...
    OUTPUT_DIM: int = 1
    REWEIGHT_LOSS_FOR_IMBALANCED_CLASSES: bool = False
    ...
    PYG_DATASET_KEY: str = 'MUTAG'
    MODEL_SAVE_SUBDIR: str = 'MUTAG'
    RESULTS_SAVE_SUBDIR: str = 'MUTAG'
